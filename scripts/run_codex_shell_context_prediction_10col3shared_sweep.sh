...
seeds="${SEEDS:-42}"
weights="${WEIGHTS:-0.00025 0.0005 0.001}"
lr="${LR:-0.005}"
num_epochs="${NUM_EPOCHS:-20}"
diagnose_mode="${DIAGNOSE_MODE:-composer_shells}"
shell_lr_multipliers="${SHELL_LR_MULTIPLIERS:-1,1.5,2,3}"
master_log="${repo_root}/results/codex_shell_context_prediction_10col3shared_${hostname_value}_${timestamp}.log"
...

{
    ...
    echo "outer_shell_context direct readout: disabled when weight > 0"
