...
master_log="${repo_root}/results/codex_shell_dynamics_replicate_sweep_${hostname_value}_${timestamp}.log"
...

{
    ...
    echo
    echo "planned_cases:"
    echo "1. seed99_shell_dynamics_bridge_plus_direct_readout"
    echo "2. seed42_shell_dynamics_bridge_plus_direct_readout"
    echo "3. seed7_shell_dynamics_bridge_plus_direct_readout"
    echo

    run_case "seed99_shell_dynamics_bridge_plus_direct_readout" 99
    run_case "seed42_shell_dynamics_bridge_plus_direct_readout" 42
    run_case "seed7_shell_dynamics_bridge_plus_direct_readout" 7
