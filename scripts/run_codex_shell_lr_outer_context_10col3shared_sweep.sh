...
master_log="${repo_root}/results/codex_shell_lr_outer_context_10col3shared_${hostname_value}_${timestamp}.log"
...

{
    ...
    run_case "seed42_shell_lr_outer_context_no_teachers" 42
    run_case "seed99_shell_lr_outer_context_no_teachers" 99
    run_case "seed7_shell_lr_outer_context_no_teachers" 7
