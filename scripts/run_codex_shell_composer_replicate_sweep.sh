...
master_log="${repo_root}/results/codex_shell_composer_replicate_sweep_${hostname_value}_${timestamp}.log"
...
run_case() {
    ...
    bash "$runner" "$seed" 0.005 shells 20 0.0 0,0,0,0 nobypass 0,0,0,0 on on shell_attention
...

{
    ...
    echo
    echo "planned_cases:"
    echo "1. seed99_shell_composer_bridge_plus_direct_readout"
    echo "2. seed42_shell_composer_bridge_plus_direct_readout"
    echo "3. seed7_shell_composer_bridge_plus_direct_readout"
    echo

    run_case "seed99_shell_composer_bridge_plus_direct_readout" 99
    run_case "seed42_shell_composer_bridge_plus_direct_readout" 42
    run_case "seed7_shell_composer_bridge_plus_direct_readout" 7
