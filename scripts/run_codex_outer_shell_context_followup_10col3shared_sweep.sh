...
master_log="${repo_root}/results/codex_outer_shell_context_followup_10col3shared_${hostname_value}_${timestamp}.log"
...
run_case() {
    local case_name="$1"
    local seed="$2"
    local column_shell_teacher_weights="$3"
...

{
    ...
    echo
    echo "planned_cases:"
    echo "1. seed42_outer_context_no_outer_teacher"
    echo "2. seed42_outer_context_outer_teacher0p006"
    echo "3. seed99_outer_context_outer_teacher0p002"
    echo "4. seed7_outer_context_outer_teacher0p002"
    echo

    run_case "seed42_outer_context_no_outer_teacher" 42 0,0,0,0
    run_case "seed42_outer_context_outer_teacher0p006" 42 0,0,0,0.006
    run_case "seed99_outer_context_outer_teacher0p002" 99 0,0,0,0.002
    run_case "seed7_outer_context_outer_teacher0p002" 7 0,0,0,0.002
